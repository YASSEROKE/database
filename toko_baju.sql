...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 12, 2023 at 05:02 AM
...
(1, 'budi', 'gang damai', 89786),
(2, 'yanto', 'gang lele', 89876),
(3, 'anto', 'gang ayam', 8111);
...
INSERT INTO `transaksi` (`id_transaksi`, `id_pelanggan`, `tanggal`, `total_pembayaran`) VALUES
(1, 1, '2023-08-01', 12000),
(2, 3, '2014-08-06', 45000),
(3, NULL, NULL, NULL),
(8, 3, '2023-08-01', 45000),
(78, 3, '2019-08-02', 54333);
...
--
ALTER TABLE `transaksi`
  MODIFY `id_transaksi` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
